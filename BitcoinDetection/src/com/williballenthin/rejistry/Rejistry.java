...
public class Rejistry {
    ...
    public static void printVKRecord(VKRecord record, String prefix) throws RegistryParseException, UnsupportedEncodingException {
    ...
    public static void printNKRecord(NKRecord record, String prefix) throws IOException, RegistryParseException {
    ...
    public static void recurseNKRecord(NKRecord record, String prefix) throws IOException, RegistryParseException {
